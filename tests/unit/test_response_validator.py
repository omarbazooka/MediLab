...
def test_response_validator_warns_on_ungrounded_price() -> None:
    """Draft containing a price absent from structured evidence is flagged."""
    ...
    assert any("Price 999.00 not verified" in r for r in update["validation_result"]["reasons"])
